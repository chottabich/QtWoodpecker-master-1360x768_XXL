...
class _GStat(GObject.GObject):
    ...
    __gsignals__ = {
        ...
        'velo': (GObject.SignalFlags.RUN_FIRST , GObject.TYPE_NONE,(GObject.TYPE_PYOBJECT,)),
        }
    ...
    def merge(self):
        ...
        for j in range(0, self.stat.joints):
            ...
            veloc.append(self.stat.joint[j]['velocity']*60)
    ...
    def update(self):
        ...
        # velocity
        self.emit('velo', self.old['velocity'])
